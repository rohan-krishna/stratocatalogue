...
Route::prefix('admin')->middleware('auth')->group(function() {
    ...
    Route::prefix('categories')->group(function() {
        ...
        Route::get('create','ProductCategoryController@create')->name('createNewCategory');
        
        Route::get('get-all-categories','ProductCategoryController@getAllCategories')->name('getAllCategories');
